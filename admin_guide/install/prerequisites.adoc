...
ifdef::openshift-enterprise[]
- Minimum 15 GB unallocated space to be configured via *docker-storage-setup*, see *Configuring Docker
  Storage* below
endif::[]
|===
...
*_/etc/sysconfig/docker-storage-setup_* file. Please allocate at least 15GB of
space no matter which option you choose.
