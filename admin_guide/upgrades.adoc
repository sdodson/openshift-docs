...
project, create the service account, update the SCC, and add the service-account
to the router deployment config.
...
----
Edit your router deployment config.
----
# oc edit dc/router
----
...
...
...
----
Now upgrade your router per the standard upgrade steps.
